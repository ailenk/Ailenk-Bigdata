package ink.bignose.recommend.realtime.app
...
import ink.bignose.recommend.common.constant.GmallConstant
import ink.bignose.recommend.common.util.MyEsUtil
import ink.bignose.recommend.realtime.bean.Startuplog
import ink.bignose.recommend.realtime.util.{MyKafkaUtil, RedisUtil}
